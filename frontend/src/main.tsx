...
function App() {
  ...
  const togglePostIndustry = (industry:string,checked:boolean) => setPostForm({...postForm,target_industries:checked?[...new Set([...postForm.target_industries,industry])]:postForm.target_industries.filter(i=>i!==industry)});
